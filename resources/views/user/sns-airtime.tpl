...
{block name=title}{$network|upper} Airtime Share{/block}
{block name=body}
    <form method="POST" action="{$route->urlFor('sns-airtime',['network' => $network])}"
        onsubmit="return ajaxPost('sns-airtime');" id="sns-airtime">
        <div class="">
            <div class="">
